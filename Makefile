...
ameblo: builds/downloader_ameblo_mayuri.js builds/downloader_ameblo_honoka.js builds/downloader_ameblo_mai.js builds/downloader_ameblo_sakurako.js builds/downloader_ameblo_yuria.js builds/downloader_ameblo_yombo.js 
...
builds/downloader_ameblo_yombo.js: downloader_ameblo.js
	mkdir -p builds
	sed 's/__AMEBLO_ACCOUNT/yombo444/g' $^ > $@
